...
*   **gNewSense Spin** 🔄
    ...
    *   **Downloads:** 💿 [64-Bit (amd64)](YOUR_LINK) | 💿 [32-Bit (i686)](YOUR_LINK)
    *   **Included Interfaces (22):** COSMIC*, Hyprland*, Unity, CDE, Xfce, Cinnamon, MATE, LXQt, LXDE, Budgie, KDE Plasma Mobile, Trinity (TDE), JWM, Sway*, Deepin, Pantheon, Enlightenment, GNOME Flashback, Phosh, Sugar, Budgie, standard multi-session profiles. (*Starred items available on 64-bit ISO only*).
